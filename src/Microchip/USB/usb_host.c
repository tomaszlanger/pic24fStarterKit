...
USB_ROOT_HUB_INFO           usbRootHubInfo;                             // Information about a specific port.
...
/****************************************************************************
  ...
  Remarks:
    This function is used so client drives do not erroneously allow incorrect
...
/****************************************************************************
  ...
  Remarks:
    ...
    The TOKBUSY bit will read 1 as soon as the U1TOK register is written.
    So we do not have to worry about the case where this routine is called
    twice during the SOF threshold time.
  ***************************************************************************/
...
void _USB_NotifyClients( BYTE address, USB_EVENT event, void *data, unsigned int size )
{
    ...
    // To Do: This is a temporary patch for EP0 on a "composite" device.  In this
...
/****************************************************************************
  ...
  Remarks:
    ...
    * TODO: Add checks for descriptors that are shorter than the expected
        length?
  ***************************************************************************/
