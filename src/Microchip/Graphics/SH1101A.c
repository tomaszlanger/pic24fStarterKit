...
/*********************************************************************
* Function: void BarHS2(SHORT xtop, SHORT ytop, SHORT xbot, SHORT ybot)
*
* PreCondition: none
*
* Input: xtop, ytop top left coordinates
* Input: xbot, ybot bottom right coordinates
*
* Output: none
*
* Side Effects: none
*
* Overview: high speed bar drawing routine
*
* Note: none
*
********************************************************************/
...
/*********************************************************************
* Function: void BarHSP(SHORT xtop, SHORT ytop,SHORT xbot, SHORT ybot, SHORT pat, SHORT xo)
*
* PreCondition: none
*
* Input: xtop, ytop top left coordinates
* Input: xbot, ybot bottom right coordinates
* Input: pat pattern byte
* Input: xo byte mask to be XORed with pattern byte
*
* Output: none
*
* Side Effects: none
*
* Overview: high speed bar drawing routine with XORed pattern
*
* Note: none
*
********************************************************************/
