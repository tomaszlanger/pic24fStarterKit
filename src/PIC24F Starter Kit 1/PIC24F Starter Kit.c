...
void TranslateMessageGeneric( GOL_MSG * pMsg )
{
        ...
        (pMsg->param1  == ID_TOUCH_PAD))
    {
        switch (pMsg->param2)
        {
            ...
            case SCAN_PGUP_PRESSED:
                break;

            case SCAN_PGDOWN_PRESSED:
                break;

            case SCAN_HOME_PRESSED:
                break;

            case SCAN_END_PRESSED:
                break;

            case SCAN_PGUP_RELEASED:
                break;

            case SCAN_PGDOWN_RELEASED:
                break;

            case SCAN_HOME_RELEASED:
                break;

            case SCAN_END_RELEASED:
                break;
